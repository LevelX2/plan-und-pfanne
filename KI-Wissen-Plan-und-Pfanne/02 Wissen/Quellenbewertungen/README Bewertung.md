...
- `npm run lint` und `npm run build`: hoch verlässlich für den aktuellen technischen Verifikationsstand, inklusive Warnhinweisen

## Bewertungslogik
- Repository-Code schlägt ältere Zusammenfassungen, wenn beides einander widerspricht.
- Projektzusammenfassungen bleiben nützlich, solange ihr Aktualitätsgrad sichtbar bleibt.
- Webquellen werden nur ergänzend genutzt, wenn das Projektwissen oder der Code dazu Lücken haben.
